    ...
    <SafeAreaView style={[styles.container, {width: Dimensions.get('window').width}]} >
        <View style={styles.roleIndicator}>
          ...
          onPress={onPressPublic}
              style={[styles.buttonContainer, {backgroundColor: 'teal'}, {borderTopLeftRadius: 10}, {borderBottomLeftRadius: 10}]}
            >
        ...
        <View style ={styles.keyboardAvoidingContainer}>
          ...
          <View style={[{flexDirection:'row'},{justifyContent:'center'}]}>
            ...
            <Text style={[styles.heading,{color:'#20476b'}, {fontWeight:'800'}]}>PUBLIC</Text>
          </View>
